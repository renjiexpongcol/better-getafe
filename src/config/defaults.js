...
for (const [category, prefix, legacy] of [['database', 'CMS', 'DB'], ['portalDatabase', 'PORTAL', 'USER_DB']]) {
  Object.assign(definitions, {
    [`${category}.provider`]: choice('Database provider', `${prefix}_DATABASE_PROVIDER${prefix === 'PORTAL' ? '|USER_DATABASE_PROVIDER' : ''}|${prefix === 'CMS' ? 'DB_PROVIDER' : 'USER_DATABASE_PROVIDER'}`, 'postgresql', ['postgresql']),
